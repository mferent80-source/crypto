...
console.log(`V57_RUNTIME_PASS worker_logistic=${log.w.length} stumps=${st.stumps.length} cvd=${cvd.finalCvd} mc_deterministic=1 mtf_one=${one.confidence}% same_candle=${w[0]}`);
