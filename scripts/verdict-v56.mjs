...
console.log(`V56_VERDICT_EXPLAINER_PASS base=${out.base} risk=${out.riskState.replaceAll(' ','_')} agreement=${out.agreement}% support=${out.support.length} opposition=${out.opposition.length}`);
