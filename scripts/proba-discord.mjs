...
if (!esteWebhookDiscord(w)) { console.log("  DISCORD_WEBHOOK lipsește sau nu are forma unei adrese de webhook Discord."); process.exitCode = 1; } else {
...
process.exitCode = ok ? 0 : 1;   // fara process.exit(): pe Windows, cu fetch-ul inca deschis, Node se opreste cu "Assertion failed"
}
